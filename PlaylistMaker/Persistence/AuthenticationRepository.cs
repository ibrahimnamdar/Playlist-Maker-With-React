...
namespace PlaylistMaker.Persistence
{
    public class AuthenticationRepository : IAuthenticationRepository
    {
        ...
        {
            var redirectUrl = $"{AppSettings.AccountBaseUrl}/authorize?client_id={AppSettings.ClientId}&redirect_uri=https://localhost:44320/callback&response_type=code&scope=user-read-private user-read-email";
